...
public class ResourceEvent implements Serializable{
	...
	private static final long serialVersionUID = 509647349780921348L;
	private ProductState parent;
	private ProductState child;
	private int eventTime;
	
	private AID eventAgent;
	 ...
	 * @param eventTime
	 */
	public ResourceEvent(AID aid, ProductState parent, ProductState child, String activeMethod, int eventTime){
		this.parent = parent;
		this.child = child;
	...
	public ResourceEvent copy(){
		...
		edge = new ResourceEvent(this.eventAgent, parent.copy(), child.copy(), activeMethod, this.eventTime);
